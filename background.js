...
function initBackground() {
    ...
    background.innerHTML = `
        <div class="fixed inset-0 z-[-1] bg-[#0C0A09] pointer-events-none">
            <div class="absolute inset-0 bg-[linear-gradient(to_right,rgba(227,176,74,0.02)_1px,transparent_1px),linear-gradient(to_bottom,rgba(227,176,74,0.02)_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_80%_at_50%_0%,#000_40%,transparent_100%)]"></div>
